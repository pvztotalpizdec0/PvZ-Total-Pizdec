...
std::string Sexy::DIALOG_YES_STRING				= "[S_DIALOG_BUTTON_YES]";
std::string Sexy::DIALOG_NO_STRING				= "[S_DIALOG_BUTTON_NO]";
std::string Sexy::DIALOG_OK_STRING				= "[S_DIALOG_BUTTON_OK]";
std::string Sexy::DIALOG_CANCEL_STRING			= "[DIALOG_BUTTON_CANCEL]";
