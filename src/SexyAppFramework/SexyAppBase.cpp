...
SexyAppBase::SexyAppBase()
{
...
#ifdef __SWITCH__
	mResourceDir = "sdmc:/switch/PvZTotalPizdec/";
#elif defined(__3DS__)
	mResourceDir = "sdmc:/3ds/PvZTotalPizdec/";
	...
	SetString("S_DIALOG_BUTTON_OK",		"[S_DIALOG_BUTTON_OK]");
	SetString("S_DIALOG_BUTTON_CANCEL","[S_DIALOG_BUTTON_CANCEL]");
...
void SexyAppBase::Init()
{
	...
	{
		char* aPrefPath = SDL_GetPrefPath("io.github.pvztotalpizdec", "PvZTotalPizdec"); // Avoid conflict with official Plants vs. Zombies
		if (aPrefPath)
		{
