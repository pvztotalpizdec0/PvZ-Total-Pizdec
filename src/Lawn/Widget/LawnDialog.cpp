	...
	Dialog(nullptr, nullptr, theId, isModal, theDialogHeader, theDialogLines, "", BUTTONS_NONE)
{
    ...
    if (theButtonMode == 1)
    {
        mLawnYesButton = MakeButton(1000, this, mApp->GetString("BUTTON_YES", "[BUTTON_YES]"));
        mLawnNoButton = MakeButton(1001, this, mApp->GetString("BUTTON_NO", "[BUTTON_NO]"));
    }
    else if (theButtonMode == 2)
    {
        mLawnYesButton = MakeButton(1000, this, mApp->GetString("BUTTON_OK", "[BUTTON_OK]"));
        mLawnNoButton = MakeButton(1001, this, mApp->GetString("BUTTON_CANCEL", "[BUTTON_CANCEL]"));
    }
