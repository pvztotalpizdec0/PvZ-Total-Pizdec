...
constinit const ProjectileDefinition gProjectileDefinition[] = {
	...
	{ .mProjectileType = ProjectileType::PROJECTILE_SNOWPEA, .mImageRow = 0, .mDamage = 10 },
	...
	{ .mProjectileType = ProjectileType::PROJECTILE_BIG_PEA, .mImageRow = 0, .mDamage = 40 }
};
...
bool Projectile::CantHitHighGround()
{
	...
	return (
		...
		mProjectileType == ProjectileType::PROJECTILE_BIG_PEA ||
...
void Projectile::DoImpact(Zombie* theZombie)
{
	...
	case ProjectileType::PROJECTILE_BIG_PEA:
		aSplatPosX -= 15.0f;
