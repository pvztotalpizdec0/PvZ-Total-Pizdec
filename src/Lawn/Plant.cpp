...
constinit const PlantDefinition gPlantDefs[SeedType::NUM_SEED_TYPES] = {
    { .mSeedType = SeedType::SEED_PEASHOOTER,        .mPlantImage = nullptr, .mReanimationType = ReanimationType::REANIM_PEASHOOTER,    .mPacketIndex = 0,  .mSeedCost = 100, .mRefreshTime = 750,    .mSubClass = PlantSubClass::SUBCLASS_SHOOTER, .mLaunchRate = 125,  .mPlantName = "PEASHOOTER" },
    ...
    { .mSeedType = SeedType::SEED_WALLNUT,           .mPlantImage = nullptr, .mReanimationType = ReanimationType::REANIM_WALLNUT,       .mPacketIndex = 2,  .mSeedCost = 75,  .mRefreshTime = 5000,   .mSubClass = PlantSubClass::SUBCLASS_NORMAL,  .mLaunchRate = 0,    .mPlantName = "WALL_NUT" },
    { .mSeedType = SeedType::SEED_POTATOMINE,        .mPlantImage = nullptr, .mReanimationType = ReanimationType::REANIM_POTATOMINE,    .mPacketIndex = 37, .mSeedCost = 50,  .mRefreshTime = 2000,   .mSubClass = PlantSubClass::SUBCLASS_NORMAL,  .mLaunchRate = 0,    .mPlantName = "POTATO_MINE" },
    { .mSeedType = SeedType::SEED_SNOWPEA,           .mPlantImage = nullptr, .mReanimationType = ReanimationType::REANIM_SNOWPEA,       .mPacketIndex = 4,  .mSeedCost = 225, .mRefreshTime = 750,    .mSubClass = PlantSubClass::SUBCLASS_SHOOTER, .mLaunchRate = 125,  .mPlantName = "SNOW_PEA" },
    { .mSeedType = SeedType::SEED_CHOMPER,           .mPlantImage = nullptr, .mReanimationType = ReanimationType::REANIM_CHOMPER,       .mPacketIndex = 31, .mSeedCost = 225, .mRefreshTime = 750,    .mSubClass = PlantSubClass::SUBCLASS_NORMAL,  .mLaunchRate = 0,    .mPlantName = "CHOMPER" },
    { .mSeedType = SeedType::SEED_REPEATER,          .mPlantImage = nullptr, .mReanimationType = ReanimationType::REANIM_REPEATER,      .mPacketIndex = 5,  .mSeedCost = 225, .mRefreshTime = 750,    .mSubClass = PlantSubClass::SUBCLASS_SHOOTER, .mLaunchRate = 125,  .mPlantName = "REPEATER" },
    { .mSeedType = SeedType::SEED_PUFFSHROOM,        .mPlantImage = nullptr, .mReanimationType = ReanimationType::REANIM_PUFFSHROOM,    .mPacketIndex = 6,  .mSeedCost = 0,   .mRefreshTime = 825,    .mSubClass = PlantSubClass::SUBCLASS_SHOOTER, .mLaunchRate = 125,  .mPlantName = "PUFF_SHROOM" },
    ...
    { .mSeedType = SeedType::SEED_FUMESHROOM,        .mPlantImage = nullptr, .mReanimationType = ReanimationType::REANIM_FUMESHROOM,    .mPacketIndex = 9,  .mSeedCost = 125, .mRefreshTime = 750,    .mSubClass = PlantSubClass::SUBCLASS_SHOOTER, .mLaunchRate = 125,  .mPlantName = "FUME_SHROOM" },
    { .mSeedType = SeedType::SEED_GRAVEBUSTER,       .mPlantImage = nullptr, .mReanimationType = ReanimationType::REANIM_GRAVE_BUSTER,  .mPacketIndex = 40, .mSeedCost = 125, .mRefreshTime = 2750,   .mSubClass = PlantSubClass::SUBCLASS_NORMAL,  .mLaunchRate = 0,    .mPlantName = "GRAVE_BUSTER" },
    { .mSeedType = SeedType::SEED_HYPNOSHROOM,       .mPlantImage = nullptr, .mReanimationType = ReanimationType::REANIM_HYPNOSHROOM,   .mPacketIndex = 10, .mSeedCost = 25,  .mRefreshTime = 5000,   .mSubClass = PlantSubClass::SUBCLASS_NORMAL,  .mLaunchRate = 0,    .mPlantName = "HYPNO_SHROOM" },
    { .mSeedType = SeedType::SEED_SCAREDYSHROOM,     .mPlantImage = nullptr, .mReanimationType = ReanimationType::REANIM_SCRAREYSHROOM, .mPacketIndex = 33, .mSeedCost = 225, .mRefreshTime = 2250,   .mSubClass = PlantSubClass::SUBCLASS_SHOOTER, .mLaunchRate = 125,  .mPlantName = "SCAREDY_SHROOM" },
    { .mSeedType = SeedType::SEED_ICESHROOM,         .mPlantImage = nullptr, .mReanimationType = ReanimationType::REANIM_ICESHROOM,     .mPacketIndex = 36, .mSeedCost = 125, .mRefreshTime = 5000,   .mSubClass = PlantSubClass::SUBCLASS_NORMAL,  .mLaunchRate = 25,   .mPlantName = "ICE_SHROOM" },
    { .mSeedType = SeedType::SEED_DOOMSHROOM,        .mPlantImage = nullptr, .mReanimationType = ReanimationType::REANIM_DOOMSHROOM,    .mPacketIndex = 20, .mSeedCost = 75,  .mRefreshTime = 5000,   .mSubClass = PlantSubClass::SUBCLASS_NORMAL,  .mLaunchRate = 0,    .mPlantName = "DOOM_SHROOM" },
    ...
    { .mSeedType = SeedType::SEED_SQUASH,            .mPlantImage = nullptr, .mReanimationType = ReanimationType::REANIM_SQUASH,        .mPacketIndex = 21, .mSeedCost = 75,  .mRefreshTime = 5000,   .mSubClass = PlantSubClass::SUBCLASS_NORMAL,  .mLaunchRate = 0,    .mPlantName = "SQUASH" },
    { .mSeedType = SeedType::SEED_THREEPEATER,       .mPlantImage = nullptr, .mReanimationType = ReanimationType::REANIM_THREEPEATER,   .mPacketIndex = 12, .mSeedCost = 325, .mRefreshTime = 750,    .mSubClass = PlantSubClass::SUBCLASS_SHOOTER, .mLaunchRate = 125,  .mPlantName = "THREEPEATER" },
    ...
    { .mSeedType = SeedType::SEED_SEASHROOM,         .mPlantImage = nullptr, .mReanimationType = ReanimationType::REANIM_SEASHROOM,     .mPacketIndex = 39, .mSeedCost = 0,   .mRefreshTime = 3000,   .mSubClass = PlantSubClass::SUBCLASS_SHOOTER, .mLaunchRate = 125,  .mPlantName = "SEA_SHROOM" },
    { .mSeedType = SeedType::SEED_PLANTERN,          .mPlantImage = nullptr, .mReanimationType = ReanimationType::REANIM_PLANTERN,      .mPacketIndex = 38, .mSeedCost = 25,  .mRefreshTime = 3000,   .mSubClass = PlantSubClass::SUBCLASS_NORMAL,  .mLaunchRate = 25,   .mPlantName = "PLANTERN" },
    { .mSeedType = SeedType::SEED_CACTUS,            .mPlantImage = nullptr, .mReanimationType = ReanimationType::REANIM_CACTUS,        .mPacketIndex = 15, .mSeedCost = 125, .mRefreshTime = 750,    .mSubClass = PlantSubClass::SUBCLASS_SHOOTER, .mLaunchRate = 125,  .mPlantName = "CACTUS" },
    ...
    { .mSeedType = SeedType::SEED_SPLITPEA,          .mPlantImage = nullptr, .mReanimationType = ReanimationType::REANIM_SPLITPEA,      .mPacketIndex = 32, .mSeedCost = 125, .mRefreshTime = 750,    .mSubClass = PlantSubClass::SUBCLASS_SHOOTER, .mLaunchRate = 125,  .mPlantName = "SPLIT_PEA" },
    { .mSeedType = SeedType::SEED_STARFRUIT,         .mPlantImage = nullptr, .mReanimationType = ReanimationType::REANIM_STARFRUIT,     .mPacketIndex = 30, .mSeedCost = 125, .mRefreshTime = 750,    .mSubClass = PlantSubClass::SUBCLASS_SHOOTER, .mLaunchRate = 125,  .mPlantName = "STARFRUIT" },
    ...
    { .mSeedType = SeedType::SEED_GATLINGPEA,        .mPlantImage = nullptr, .mReanimationType = ReanimationType::REANIM_GATLINGPEA,    .mPacketIndex = 5,  .mSeedCost = 250, .mRefreshTime = 5000,   .mSubClass = PlantSubClass::SUBCLASS_SHOOTER, .mLaunchRate = 125,  .mPlantName = "GATLING_PEA" },
    ...
    { .mSeedType = SeedType::SEED_CATTAIL,           .mPlantImage = nullptr, .mReanimationType = ReanimationType::REANIM_CATTAIL,       .mPacketIndex = 27, .mSeedCost = 225, .mRefreshTime = 5000,   .mSubClass = PlantSubClass::SUBCLASS_SHOOTER, .mLaunchRate = 125,  .mPlantName = "CATTAIL" },
    ...
    { .mSeedType = SeedType::SEED_LEFTPEATER,        .mPlantImage = nullptr, .mReanimationType = ReanimationType::REANIM_REPEATER,      .mPacketIndex = 5,  .mSeedCost = 225, .mRefreshTime = 750,    .mSubClass = PlantSubClass::SUBCLASS_SHOOTER, .mLaunchRate = 125,  .mPlantName = "REPEATER" }
};
...
void Plant::PlantInitialize(int theGridX, int theGridY, SeedType theSeedType, SeedType theImitaterType)
{
    ...
    mIceTrapCounter = 0;
    mPlantAge = 0;
    mPotatomineMetamorphosis = false;
...
void Plant::UpdateShooter()
{
    ...
    if (mLaunchCounter == 29 && mSeedType == SeedType::SEED_PUFFSHROOM && mStateCountdown <= 0)
    {
        FindTargetAndFire(mRow, PlantWeapon::WEAPON_PRIMARY);
    }
    if ((mLaunchCounter == 25 || mLaunchCounter == 50) && mSeedType == SeedType::SEED_SCAREDYSHROOM)
    {
        FindTargetAndFire(mRow, PlantWeapon::WEAPON_PRIMARY);
    }
...
void Plant::UpdateGraveBuster()
{
    ...
    else if (mState == PlantState::STATE_GRAVEBUSTER_EATING && mStateCountdown == 0)
    {
        ...
        Plant* aPlant = mBoard->AddPlant(mPlantCol, mRow, SeedType::SEED_POTATOMINE);
        float aRate = RandRangeFloat(12.0f, 15.0f);
        aPlant->mStateCountdown = 150;
    }
}
...
void Plant::UpdatePotato()
{
    ...
    if (mState == PlantState::STATE_NOTREADY)
    {
        if (mStateCountdown == 0)
        {
            ...
            while (mBoard->IterateZombies(aZombie))
            {
                if (aZombie && mY - 130 <= aZombie->mPosY && mY + 115 >= aZombie->mPosY)
                {
                    if (!aZombie->mYuckyFace)
                    {
            ...
            mApp->AddTodParticle(mX + mWidth / 2, mY + mHeight / 2, static_cast<int>(RenderLayer::RENDER_LAYER_TOP), ParticleEffect::PARTICLE_MOWER_CLOUD);
        }
    }
...
void Plant::UpdateSquash()
{
    ...
    else
    {
        ...
        else if (mState == PlantState::STATE_SQUASH_DONE_FALLING)
        {
            ...
            {
                Die();
                mBoard->AddCoin(mX, mY, CoinType::COIN_USABLE_SEED_PACKET, CoinMotion::COIN_MOTION_FROM_PLANT)->mUsableSeedType = (SeedType)SEED_POTATOMINE;
            }
        }
    }
}
...
void Plant::UpdateIceShroom()
{
    ...
    if (mLaunchCounter <= 0)
    {
        ...
        for (int i = 0; i < 9; i++)
        {
            Projectile* aProjectile2 = mBoard->AddProjectile(mBoard->GridToPixelX(i, 0) + 30, 0, mRenderOrder - 1, mRow, ProjectileType::PROJECTILE_SNOWPEA);
            ...
            aProjectile2->mVelX = 0.0f;
            aProjectile2->mVelY = RandRangeFloat(3.33f, 6.66f);
        }
    }
}
...
void Plant::UpdateChomper()
{
    ...
    else if (mState == PlantState::STATE_CHOMPER_BITING)
    {
        if (mStateCountdown == 0)
        {
            ...
            {
                mApp->PlayFoley(FoleyType::FOLEY_SPLAT);
                DoRowAreaDamage(60, 0U);
                mState = PlantState::STATE_CHOMPER_BITING_MISSED;

                mApp->PlayFoley(FoleyType::FOLEY_THROW);

                float aShootAngleX = cos(DEG_TO_RAD(50.0f)) * 6.66f;
                float aShootAngleY = sin(DEG_TO_RAD(50.0f)) * 6.66f;
                for (int i = 0; i < 3; i++)
                {
                    Projectile* aProjectile = mBoard->AddProjectile(mX + 25, mY + 25, mRenderOrder - 1, mRow, ProjectileType::PROJECTILE_PEA);
                    aProjectile->mDamageRangeFlags = GetDamageRangeFlags(PlantWeapon::WEAPON_PRIMARY);
                    aProjectile->mMotionType = ProjectileMotion::MOTION_STAR;

                    switch (i)
                    {
                    case 0:     aProjectile->mVelX = 6.66f;         aProjectile->mVelY = 0.0f;             break;
                    case 1:     aProjectile->mVelX = aShootAngleX;  aProjectile->mVelY = aShootAngleY;      break;
                    case 2:     aProjectile->mVelX = aShootAngleX;  aProjectile->mVelY = -aShootAngleY;     break;
                    default:    TOD_ASSERT(false);                                                               break;
                    }
                }
            }
...
void Plant::UpdateAbilities()
{
    ...
    else if (mSeedType == SeedType::SEED_PUFFSHROOM)
    {
        if (mStateCountdown == 0)
        {
            ...
            int aPosY = mY + mHeight / 2;
            mApp->PlayFoley(FoleyType::FOLEY_PLANTGROW);
            mApp->AddTodParticle(aPosX, aPosY, static_cast<int>(RenderLayer::RENDER_LAYER_TOP), ParticleEffect::PARTICLE_IMITATER_MORPH);
            mStateCountdown = -1;
            mPlantMaxHealth = 225;
            if (mPlantHealth >= 225)
                mPlantHealth = 225;
    ...
    else if (mSeedType == SeedType::SEED_PLANTERN)
    {
        ...
        if (mLaunchCounter <= 0)
        {
            ...
            for (int i = 0; i < 9; i++)
            {
                Projectile* aProjectile2 = mBoard->AddProjectile(mBoard->GridToPixelX(i, 0) + RandRangeInt(-300, 300), 0, mRenderOrder - 1, mRow, ProjectileType::PROJECTILE_SNOWPEA);
                aProjectile2->mDamageRangeFlags = GetDamageRangeFlags(PlantWeapon::WEAPON_PRIMARY);
                aProjectile2->mMotionType = ProjectileMotion::MOTION_STAR;
                aProjectile2->mVelX = RandRangeFloat(3.33f, 6.66f);
                aProjectile2->mVelY = RandRangeFloat(3.33f, 6.66f);
            }
        }
...
void Plant::UpdateReanimColor()
{
    ...
    else if (mChilledCounter  || mIceTrapCounter)
    {
...
void Plant::Update()
{
    ...
    if (doUpdate)
    {
        int aSkipEcerySecondFrame = mChilledCounter % 2;
        if (mIceTrapCounter == 0 && aSkipEcerySecondFrame == 0)
        {
            UpdateAbilities();
            Animate();
    ...
    if (mIceTrapCounter > 0)
    {
        ...
        if (mIceTrapCounter == 0)
        {
            ...
            int aPosY = mY + mHeight / 2;
            RemoveIceTrap();
            mApp->AddTodParticle(aPosX, aPosY, static_cast<int>(RenderLayer::RENDER_LAYER_TOP), ParticleEffect::PARTICLE_ICE_TRAP_RELEASE);
        }
    }
}
    ...
    if (mPlantHealth < mPlantMaxHealth / 3)
    {
        if (aImageOverride != aCracked2)
        {
            ...
            if (mSeedType == SeedType::SEED_WALLNUT)
            {
                ...
                int aPosY = mY + mHeight / 2;
                int aDamageRangeFlags = GetDamageRangeFlags(PlantWeapon::WEAPON_PRIMARY);
                mApp->AddTodParticle(aPosX, aPosY, static_cast<int>(RenderLayer::RENDER_LAYER_TOP), ParticleEffect::PARTICLE_ICEBALL_DEATH);
                ...
                while (mBoard->IterateZombies(aZombie))
                {
                    if (aZombie->EffectedByDamage(aDamageRangeFlags))
                    {
                        ...
                        if (aRowDist <= 1 && aRowDist >= -1 && GetCircleRectOverlap(aPosX, aPosY, 115, aZombieRect))
                        {
                            aZombie->TakeDamage(20, 101U);
                        }
                    }
                }
            }
    ...
    else if (mPlantHealth < mPlantMaxHealth * 2 / 3)
    {
        if (aImageOverride != aCracked1)
        {
            ...
            if (mSeedType == SeedType::SEED_WALLNUT)
            {
                ...
                int aPosY = mY + mHeight / 2;
                int aDamageRangeFlags = GetDamageRangeFlags(PlantWeapon::WEAPON_PRIMARY);
                mApp->AddTodParticle(aPosX, aPosY, static_cast<int>(RenderLayer::RENDER_LAYER_TOP), ParticleEffect::PARTICLE_FIREBALL_DEATH);
...
void Plant::Draw(Graphics* g)
{
    ...
    else
    {
        ...
        if (mSeedType == SeedType::SEED_POTATOMINE && IsOnBoard())
        {
            if (mStateCountdown == 0)
                mPotatomineMetamorphosis = false;
            float aCenterX = 50.0f;
            float aCenterY = 40.0f;
            int aNumImages = 3;    
            float aRadius = 60.0f;     
            float aSpeed = 0.05f;      
            float aScale = 0.7f;       
            int aFadeOut = TodAnimateCurve(1645, 1605, mPlantAge, 0, 255, CURVE_EASE_OUT);

            Image* aOrbitImage;
            if (mPotatomineMetamorphosis)
                aOrbitImage = IMAGE_REANIM_GARLIC_BODY3;
            else
                aOrbitImage = nullptr;

            if (aOrbitImage != nullptr)
            {
                int aScaledWidth = aOrbitImage->GetWidth() * aScale;
                int aScaledHeight = aOrbitImage->GetHeight() * aScale;

                for (int i = 0; i < aNumImages; i++) 
                {
                    float aAngle = (mPlantAge * aSpeed) + (i * 2.0f * 3.14159f / aNumImages);
                    float aDrawX = aCenterX + aRadius * cos(aAngle);
                    float aDrawY = aCenterY + aRadius * sin(aAngle);

                    aDrawX -= aScaledWidth / 2.0f;
                    aDrawY -= aScaledHeight / 2.0f;

                    Rect aSrcRect(0, 0, aOrbitImage->GetWidth(), aOrbitImage->GetHeight()); 
                    Rect aDestRect((int)aDrawX, (int)aDrawY, aScaledWidth, aScaledHeight); 

                    g->SetColorizeImages(true);
                    g->SetColor(Color(255, 255, 255, aFadeOut));
                    g->DrawImage(aOrbitImage, aDestRect, aSrcRect);
...
void Plant::DoSpecial()
{
    ...
    case SeedType::SEED_DOOMSHROOM:
    {
        ...
        while (mBoard->IteratePlants(aPlant))
        {
            if (GetCircleRectOverlap(aPosX, aPosY, 250, aPlant->GetPlantRect()))
            {
                mBoard->mPlantsEaten++;
                aPlant->Die();
                for (int i = 0; i < GetCost(aPlant->mSeedType, aPlant->mImitaterType) / 25; i++)
                {
                    mBoard->AddCoin(aPlant->mX, aPlant->mY, CoinType::COIN_SMALLSUN, CoinMotion::COIN_MOTION_FROM_PLANT);
                }
            }
        }
        break;
...
void Plant::Fire(Zombie* theTargetZombie, int theRow, PlantWeapon thePlantWeapon)
{
    ...
    else if (mSeedType == SeedType::SEED_FUMESHROOM)
    {
        aOriginX = mX + 85;
        aOriginY = mY + 31;
    }
    ...
    else if (mSeedType == SeedType::SEED_LEFTPEATER)
    {
        ...
        if (mShootsCounter == 2)
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                Projectile* aProjectile2 = mBoard->AddProjectile(aOriginX, aOriginY, mRenderOrder - 1, mRow, ProjectileType::PROJECTILE_PEA);
                aProjectile2->mDamageRangeFlags = GetDamageRangeFlags(PlantWeapon::WEAPON_PRIMARY);
                aProjectile2->mMotionType = ProjectileMotion::MOTION_STAR;
    ...
    else if (mShootsCounter == 7 && mSeedType == SeedType::SEED_PEASHOOTER)
    {
        int aPosX = mX + mWidth / 2;
        int aPosY = mY + mHeight / 2;
        mApp->AddTodParticle(aPosX, aPosY, static_cast<int>(RenderLayer::RENDER_LAYER_TOP), ParticleEffect::PARTICLE_IMITATER_MORPH);
        ...
        for (int i = 0; i < 7; i++)
        {
            ...
            switch (i)
            {
            case 0:     aProjectile2->mVelX = -3.33f;         aProjectile2->mVelY = 0.0f;             break;
            case 1:     aProjectile2->mVelX = 0.0f;          aProjectile2->mVelY = 3.33f;             break;
            case 2:     aProjectile2->mVelX = 0.0f;          aProjectile2->mVelY = -3.33f;            break;
            case 3:     aProjectile2->mVelX = aShootAngleX;  aProjectile2->mVelY = aShootAngleY;      break;
            case 4:     aProjectile2->mVelX = aShootAngleX;  aProjectile2->mVelY = -aShootAngleY;     break;
            case 5:     aProjectile2->mVelX = -aShootAngleX;  aProjectile2->mVelY = aShootAngleY;      break;
            case 6:     aProjectile2->mVelX = -aShootAngleX;  aProjectile2->mVelY = -aShootAngleY;     break;
            default:    TOD_ASSERT(false);                                                               break;
            }
        }
        mShootsCounter = 0;
    }
    else if (mShootsCounter == 15 && mSeedType == SeedType::SEED_SNOWPEA)
    {
        Zombie* aZombie = nullptr;
        while (mBoard->IterateZombies(aZombie))
        {
    ...
    else if (mShootsCounter == 2 && mSeedType == SeedType::SEED_REPEATER)
    {
        float aShootAngleX = cos(DEG_TO_RAD(30.0f)) * 3.33f;
        float aShootAngleY = sin(DEG_TO_RAD(30.0f)) * 3.33f;
        for (int i = 0; i < 2; i++)
    ...
    else if (mShootsCounter == 3 && mSeedType == SeedType::SEED_FUMESHROOM)
    {
        float aShootAngleX = cos(DEG_TO_RAD(30.0f)) * 3.33f;
        float aShootAngleY = sin(DEG_TO_RAD(30.0f)) * 3.33f;
        for (int i = 0; i < 2; i++)
    ...
    else if (mSeedType == SeedType::SEED_SCAREDYSHROOM)
    {
        ...
        for (int i = 0; i < 2; i++)
        {
            Projectile* aProjectile2 = mBoard->AddProjectile(aOriginX, aOriginY, mRenderOrder - 1, mRow, ProjectileType::PROJECTILE_PUFF);
            aProjectile2->mDamageRangeFlags = GetDamageRangeFlags(PlantWeapon::WEAPON_PRIMARY);
            aProjectile2->mMotionType = ProjectileMotion::MOTION_STAR;
...
Zombie* Plant::FindTargetZombie(int theRow, PlantWeapon thePlantWeapon)
{
    ...
    while (mBoard->IterateZombies(aZombie))
    {
        ...
        if (aZombie->EffectedByDamage(aDamageRangeFlags))
        {
            ...
            if (aZombie->mZombieType == ZombieType::ZOMBIE_DOOR && aZombie->mShieldType == ShieldType::SHIELDTYPE_DOOR && mSeedType != SeedType::SEED_CABBAGEPULT && mSeedType != SeedType::SEED_KERNELPULT && mSeedType != SeedType::SEED_MELONPULT && mSeedType != SeedType::SEED_WINTERMELON)
            {
                mPlantHealth -= 10;
...
Rect Plant::GetPlantAttackRect(PlantWeapon thePlantWeapon)
{
    ...
    case SeedType::SEED_CHOMPER:        aRect = Rect(mX + 80,       mY,             160,                mHeight);               break;
    case SeedType::SEED_SPIKEWEED:
...
bool Plant::CanBeChilled()
{
    if (mSeedType == SeedType::SEED_SNOWPEA ||
        ...
        mSeedType == SeedType::SEED_TORCHWOOD)
        return false;
...
void Plant::DrawIceTrap(Graphics* g, bool theFront)
{
    float aOffsetX = 12.46f;
    float aOffsetY = 50.0f;
    float aScale = 1.0f;
